...
try {
    Invoke-WebRequest "https://gitlab.com/Shahzaib-YT/enigmano-multi-instance/-/raw/main/Chrome-Extensions.ps1" -OutFile Chrome-Extensions.ps1
    .\Chrome-Extensions.ps1
} catch {
    Fail "Chrome extensions deployment failed: $_"
}

# === VISUAL SIGNATURE DEPLOYMENT ===
try {
    Invoke-WebRequest "https://gitlab.com/Shahzaib-YT/enigmano-multi-instance/-/raw/main/personalize.ps1" -OutFile personalize.ps1
    .\personalize.ps1
} catch {
    Fail "Visual signature deployment failed: $_"
}
